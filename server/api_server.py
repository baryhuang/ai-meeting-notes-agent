...
CONFIG_SCHEMA = [
    ...
    {"key": "OPENAI_API_KEY", "group": "AI Chat", "label": "API Key", "secret": True},
    {"key": "OPENAI_BASE_URL", "group": "AI Chat", "label": "Base URL", "default": "https://api.openai.com/v1"},
    {"key": "OPENAI_MODEL", "group": "AI Chat", "label": "Model", "default": "gpt-4o-mini"},
    {"key": "GLM_API_KEY", "group": "File Analysis", "label": "GLM API Key", "secret": True},
    {"key": "GLM_MODEL", "group": "File Analysis", "label": "Model", "default": "glm-4-plus"},
    {"key": "ANTHROPIC_BASE_URL", "group": "File Analysis", "label": "Anthropic Base URL", "default": "https://api.z.ai/api/anthropic"},
